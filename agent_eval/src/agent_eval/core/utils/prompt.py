...
ANSWER_CORRECTNESS_PROMPT = """You are an expert evaluator. Your task is to evaluate whether a response correctly answers a question based on the expected answer.
